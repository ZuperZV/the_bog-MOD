...
public class TheBogTeleporter implements ITeleporter {
    ...
    public TheBogTeleporter(BlockPos pos, boolean insideDim) {
        thisPos = pos;
    ...
    public Entity placeEntity(Entity entity, ServerLevel currentWorld, ServerLevel destinationWorld,
        ...
        if (insideDimension) {
            ...
            for (BlockPos checkPos : BlockPos.betweenClosed(destinationPos.below(10).west(10),
                ...
                if (destinationWorld.getBlockState(checkPos).getBlock() instanceof TheBogPortal) {
                    doSetBlock = false;
                    break;
                }
            }
            ...
            if (doSetBlock) {
                destinationWorld.setBlock(destinationPos, ModBlocks.THE_BOG_PORTAL.get().defaultBlockState(), 3);
            }
        }
