...
public class ModDiamondBowItem extends ProjectileWeaponItem implements Vanishable {
    public static final int MAX_DRAW_DURATION = 10;
    public static final int DEFAULT_RANGE = 35;

    public ModDiamondBowItem(Properties pProperties) {
        super(pProperties);
    }
