...
public class ModGlobalLootModifierProvider extends GlobalLootModifierProvider {
    ...
    protected void start() {
        ...
        add("endium_from_simple_dungeon", new AddItemModifier(new LootItemCondition[] {
                new LootTableIdCondition.Builder(new ResourceLocation("chests/simple_dungeon")).build(),
                LootItemRandomChanceCondition.randomChance(0.25f).build() }, ModItems.ENDIUM_INGOT.get()));
        ...
        add("gilded_diamond_upgrade_smithing_template_from_nether_bridge", new AddItemModifier(new LootItemCondition[] {
                ...
                LootItemRandomChanceCondition.randomChance(0.48f).build() }, ModItems.GILDED_DIAMOND_UPGRADE_SMITHING_TEMPLATE.get()));
        ...
        add("gilded_diamond_upgrade_smithing_template_from_bastion_treasure", new AddItemModifier(new LootItemCondition[] {
                ...
                LootItemRandomChanceCondition.randomChance(0.35f).build() }, ModItems.GILDED_DIAMOND_UPGRADE_SMITHING_TEMPLATE.get()));

        add("gilded_netherite_upgrade_smithing_template_from_nether_bridge", new AddItemModifier(new LootItemCondition[] {
                new LootTableIdCondition.Builder(new ResourceLocation("chests/nether_bridge")).build(),
                LootItemRandomChanceCondition.randomChance(0.40f).build() }, ModItems.GILDED_NETHERITE_UPGRADE_SMITHING_TEMPLATE.get()));
    }
}