...
public class ModRecipeProvider extends RecipeProvider implements IConditionBuilder {
    ...
    protected void buildRecipes(Consumer<FinishedRecipe> pWriter) {
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModItems.GILDED_NETHERITE_UPGRADE_SMITHING_TEMPLATE.get())
                ...
                .unlockedBy("has_gilded_netherite_upgrade_smithing_template", inventoryTrigger(ItemPredicate.Builder.item().
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModItems.GILDED_DIAMOND_UPGRADE_SMITHING_TEMPLATE.get())
                ...
                .define('B', Items.GILDED_BLACKSTONE)
                .define('C', ModItems.GILDED_GOLD.get())
                .unlockedBy("has_gilded_diamond_upgrade_smithing_template", inventoryTrigger(ItemPredicate.Builder.item().
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModItems.ENDIUM_UPGRADE_SMITHING_TEMPLATE.get())
                .pattern("CAC")
                .pattern("CBC")
                .pattern("CCC")
                .define('A', ModItems.ENDIUM_UPGRADE_SMITHING_TEMPLATE.get())
                .define('B', Blocks.END_STONE)
                .define('C', Items.DIAMOND)
                .unlockedBy("has_endium_upgrade_smithing_template", inventoryTrigger(ItemPredicate.Builder.item().
                        of(ModItems.ENDIUM_UPGRADE_SMITHING_TEMPLATE.get()).build()))
                .save(pWriter, new ResourceLocation(Tool_Forge.MOD_ID, "endium_upgrade_smithing_template"));
        ...
        SmithingTransformRecipeBuilder.smithing(Ingredient.of(ModItems.ENDIUM_UPGRADE_SMITHING_TEMPLATE.get()), Ingredient.of(Items.NETHERITE_HELMET),
                Ingredient.of(ModItems.ENDIUM_INGOT.get()), RecipeCategory.COMBAT, ModItems.ENDIUM_HELMET.get()).
                unlocks("has_netherite_ingot", has(Items.NETHERITE_INGOT)).save(pWriter, new ResourceLocation(Tool_Forge.MOD_ID, "endium_helmet"));

        SmithingTransformRecipeBuilder.smithing(Ingredient.of(ModItems.ENDIUM_UPGRADE_SMITHING_TEMPLATE.get()), Ingredient.of(Items.NETHERITE_CHESTPLATE),
                        Ingredient.of(ModItems.ENDIUM_INGOT.get()), RecipeCategory.COMBAT, ModItems.ENDIUM_CHESTPLATE.get()).
                unlocks("has_netherite_ingot", has(Items.NETHERITE_INGOT)).save(pWriter, new ResourceLocation(Tool_Forge.MOD_ID, "endium_chestplate"));

        SmithingTransformRecipeBuilder.smithing(Ingredient.of(ModItems.ENDIUM_UPGRADE_SMITHING_TEMPLATE.get()), Ingredient.of(Items.NETHERITE_LEGGINGS),
                        Ingredient.of(ModItems.ENDIUM_INGOT.get()), RecipeCategory.COMBAT, ModItems.ENDIUM_LEGGINGS.get()).
                unlocks("has_netherite_ingot", has(Items.NETHERITE_INGOT)).save(pWriter, new ResourceLocation(Tool_Forge.MOD_ID, "endium_leggings"));
