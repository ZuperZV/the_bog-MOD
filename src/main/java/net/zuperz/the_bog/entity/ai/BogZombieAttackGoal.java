...
public class BogZombieAttackGoal extends MeleeAttackGoal {
    private final BogEntity bog;
    private int raiseArmTicks;

    public BogZombieAttackGoal(BogEntity pBog, double pSpeedModifier, boolean pFollowingTargetEvenIfNotSeen) {
